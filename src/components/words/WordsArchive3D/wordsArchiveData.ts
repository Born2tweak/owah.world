...
export const ARCHIVE_WORKS: ArchiveWork[] = [
  ...
  W({ id: 'machiavelli', title: 'The Prince', author: 'Niccolò Machiavelli', year: '1532', face: 'governance', image: '/words/art/machiavelli.jpg', file: null, thesis: 'Power as it is, not as it ought to be.', influence: 95,
    ...
    related: ['lee-kuan-yew', 'sun-tzu', 'aristotle'] }),
  W({ id: 'sun-tzu', title: 'The Art of War', author: 'Sun Tzu', year: 'c. 500 BCE', face: 'governance', image: '/words/art/sun-tzu.jpg', file: null, thesis: 'Win before the battle is fought.', influence: 92,
    ...
    related: ['machiavelli', 'musashi', 'deng'] }),
  W({ id: 'plato', title: 'The Republic', author: 'Plato', year: 'c. 375 BCE', face: 'governance', image: '/words/art/plato.png', file: null, thesis: 'What is justice, and who should rule?', influence: 96,
    ...
    related: ['aristotle', 'havel', 'machiavelli'] }),
  W({ id: 'aristotle', title: 'Politics', author: 'Aristotle', year: 'c. 350 BCE', face: 'governance', image: '/words/art/aristotle.jpg', file: null, thesis: 'Man is a political animal.', influence: 90,
    ...
    related: ['plato', 'machiavelli', 'nyerere'] }),
  W({ id: 'lee-kuan-yew', title: 'From Third World to First', author: 'Lee Kuan Yew', year: '2000', face: 'governance', image: '/words/art/lee-kuan-yew.jpg', file: null, thesis: 'Engineering a nation out of nothing.', influence: 90,
    overview: 'Singapore’s founding prime minister recounts how a resource-poor port with no hinterland was built into a first-world state in a single generation.',
    whyItMatters: 'The defining case study in state capacity, pragmatism, and disciplined development under constraint.',
    themes: ['Development', 'Pragmatism', 'State capacity', 'Discipline'],
    keyIdeas: ['Govern by what works, not by ideology.', 'Order and competence are preconditions for prosperity.', 'A small state survives by being exceptional.'],
    passages: [{ text: 'We knew that if we were just like our neighbours, we would die.', ref: 'On survival' }],
    related: ['deng', 'kagame', 'machiavelli'] }),
  W({ id: 'deng', title: 'Reform and Opening', author: 'Deng Xiaoping', year: '1978', face: 'governance', image: '/words/art/deng.jpg', file: null, thesis: 'Pragmatism over dogma — develop first.', influence: 92,
    overview: 'The architect of modern China’s reforms abandoned ideological purity for whatever lifted a nation out of poverty.',
    whyItMatters: 'His pragmatism moved more people out of poverty, faster, than any program in history.',
    themes: ['Reform', 'Pragmatism', 'Development', 'Power'],
    keyIdeas: ['It does not matter if the cat is black or white, so long as it catches mice.', 'Seek truth from facts.', 'Cross the river by feeling the stones.'],
    passages: [{ text: 'It doesn’t matter whether a cat is black or white, as long as it catches mice.', ref: 'On pragmatism' }],
    related: ['lee-kuan-yew', 'sun-tzu', 'kagame'] }),
  W({ id: 'havel', title: 'The Power of the Powerless', author: 'Václav Havel', year: '1978', face: 'governance', image: '/words/art/havel.jpg', file: null, thesis: 'Living in truth against the lie of power.', influence: 86,
    overview: 'The dissident playwright who became president argues that refusing to live the official lie is itself a political force.',
    whyItMatters: 'It gave the velvet revolutions their moral grammar and remains the canonical text on conscience versus the state.',
    themes: ['Conscience', 'Truth', 'Dissent', 'Power'],
    keyIdeas: ['Living in truth is the first act of resistance.', 'Power rests on everyone’s daily consent to the lie.', 'The powerless hold a hidden lever — refusal.'],
    passages: [{ text: 'The real question is whether the brighter future is always so distant.', ref: 'On hope' }],
    related: ['mandela', 'plato', 'baldwin'] }),
  W({ id: 'kagame', title: 'Governance & Reconstruction', author: 'Paul Kagame', year: '2009', face: 'governance', image: '/words/art/kagame.jpg', file: null, thesis: 'Rebuilding a nation after catastrophe.', influence: 80,
    overview: 'Rwanda’s post-genocide reconstruction — a contested, disciplined model of national rebuilding, accountability, and self-reliance.',
    whyItMatters: 'A live, debated case of how a shattered state engineers order, dignity, and development from ruin.',
    themes: ['Reconstruction', 'Leadership', 'Development', 'Self-reliance'],
    keyIdeas: ['Dignity is built, not donated.', 'Accountability is the spine of development.', 'A nation must own its own recovery.'],
    passages: [{ text: 'We chose to be a nation, not a collection of victims.', ref: 'On reconstruction' }],
    related: ['lee-kuan-yew', 'nyerere', 'mandela'] }),
  W({ id: 'nyerere', title: 'Ujamaa: Essays on Socialism', author: 'Julius Nyerere', year: '1968', face: 'governance', image: '/words/art/nyerere.png', file: '/words/books/nyerere-ujamaa.pdf', thesis: 'An African socialism rooted in the family.', influence: 80,
    ...
    related: ['nkrumah', 'sankara', 'kagame'] }),
  ...
  W({ id: 'funmilayo', title: 'The Lioness of Lisabi', author: 'Funmilayo Ransome-Kuti', year: '1949', face: 'culture', image: '/words/art/funmilayo.png', file: null, thesis: 'The mother of Nigerian women’s liberation.', influence: 82,
    overview: 'The first Nigerian woman to lead a mass movement — organising market women against colonial taxation and for the vote, and shaping a lineage of resistance.',
    whyItMatters: 'She fused feminism, anti-colonial struggle, and grassroots organising decades ahead of her time, and seeded a family that carried it forward.',
    themes: ['Women’s liberation', 'Anti-colonialism', 'Organising', 'Memory'],
    keyIdeas: ['Tax without representation is theft from the powerless.', 'The market women are a political army.', 'Liberation includes the woman or it is not liberation.'],
    passages: [{ text: 'We will not pay until we are counted.', ref: 'On the women’s tax revolt' }],
    related: ['fela', 'diop', 'ngugi'] }),
  W({ id: 'ngugi', title: 'Decolonising the Mind', author: 'Ngũgĩ wa Thiong’o', year: '1986', face: 'culture', image: '/words/art/ngugi.jpg', file: null, thesis: 'Language is the carrier of culture — and of control.', influence: 84,
    ...
    related: ['funmilayo', 'diop', 'achebe', 'fanon'] }),
  ...
  W({ id: 'baldwin', title: 'The Fire Next Time', author: 'James Baldwin', year: '1963', face: 'culture', image: '/words/art/baldwin.jpg', file: null, thesis: 'A reckoning with race, love, and America.', influence: 92,
    ...
    related: ['malcolm-x', 'soyinka', 'funmilayo'] }),

  // ---------------- AUTHOR / PERSONAL (bottom) ----------------
  W({ id: 'author-meaning', title: 'Why Meaning Emerges Locally in Finite Systems', author: 'Andrian Kolliegbo', year: '2026', face: 'author', image: '/words/art/author-meaning.png', file: '/words/books/why-meaning-emerges-locally.pdf', thesis: 'Meaning arises where finite systems act under constraint and feel the consequences.', influence: 72,
    overview: 'Opening from a sitcom marriage where forced restraint spikes productivity but drains aliveness, the essay reframes the tension between order and release through thermodynamics. In a closed universe, living things persist as open systems that export entropy locally; constraint buys efficiency by narrowing degrees of freedom while release restores vitality — and meaning emerges not from any fixed rule but locally, inside the perception–action loop where a finite system acts and feels the consequences.',
    whyItMatters: 'The author’s own synthesis — binding thermodynamics, active inference, and lived experience into a single claim about where meaning actually comes from. It anchors the Author face and threads the archive’s themes of order, mind, and vitality.',
    themes: ['Entropy', 'Regulation', 'Meaning', 'Active inference', 'Systems', 'Perception', 'Thermodynamics', 'Vitality vs order'],
    keyIdeas: [
      'Entropy is not decay but a statistical description of energy’s capacity for change.',
      'Living things persist as open systems by exporting entropy locally; stability is continuous rebuilding, not stasis.',
      'Constraint narrows degrees of freedom — short-term order at the cost of adaptability and vitality; release restores both.',
      'Perception evolved for survival, not truth — an interface tuned for action (Hoffman; Friston’s active inference).',
      'Meaning is not imposed from above; it emerges locally in the perception–action loop, where a finite system acts and feels the consequences.',
    ],
    passages: [
      { text: 'Optimization through constraints can temporarily improve productivity but comes at the cost of adaptability, regulation, and vitality.', ref: 'On constraint' },
      { text: 'Regulation cannot be imposed from some supreme view; it is something negotiated through motion.', ref: 'On regulation' },
      { text: 'Meaning arises precisely there, where finite systems act under inverse constraints and feel consequences.', ref: 'Conclusion' },
    ],
    related: ['jung', 'frankl', 'fromm', 'hawkins', 'aurobindo', 'ibn-arabi'] }),
  ...
  W({ id: 'author-field-notes', title: 'Field Notes', author: 'OWAH', year: 'in progress', face: 'author', image: '/words/art/author-field-notes.png', file: null, thesis: 'Observations from the living archive.', influence: 46,
    ...
    related: ['author-reality', 'author-meaning'] }),
