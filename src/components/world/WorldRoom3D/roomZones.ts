...
export const ZONE_LABELS: Record<WorldCategory, { title: string; subtitle: string }> = {
  fashion: { title: 'Wardrobe', subtitle: 'Darkwear archive' },
  music: { title: 'Music', subtitle: 'Listening lounge' },
  watching: { title: 'Watching', subtitle: 'Media canon' },
  life: { title: 'Life Feed', subtitle: 'Ambient pulse' },
}
